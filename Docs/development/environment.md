...
See the [STM32CubeIDE project overview](../../STM32CubeIDE/README.md) for the firmware projects included in this repository. The Web Configurator is maintained separately in the [JUMBLEQ Configurator repository](https://github.com/yamamo2shun1/JUMBLEQ-Configurator).
